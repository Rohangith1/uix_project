...
<body>
	...
	<section class="body-sign">
		<div class="circle-login">UiX </div>
				...
				<div class="panel-body">
					<form action="" method="POST">
						...
						<span class="mt-lg mb-lg  text-center text-uppercase">
							<span>Only Registered Resturant can Log In</span>
						</span>
						<div class="mb-xs text-center">
							<!--<a class="btn btn-facebook mb-md ml-xs mr-xs">Connect with <i class="fa fa-facebook"></i></a>
							<a class="btn btn-twitter mb-md ml-xs mr-xs">Connect with <i class="fa fa-twitter"></i></a>-->
						</div>
						<!--<p class="text-center">I don't have an account yet? <a href="reg_page.php">Register!</a>-->
					</form>
				</div>
			</div>
